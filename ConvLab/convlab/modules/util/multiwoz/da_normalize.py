...
valid_intent2slot['sys'] = {
    ...
    'Hotel-Inform': {'Post', 'Addr', 'Internet', 'Price', 'Ref', 'Area', 'Name', 'Parking', 'Type', 'Stars', 'none',
                     'Choice', 'Phone'},
    'Hotel-NoOffer': {'Internet', 'Area', 'Name', 'Parking', 'Type', 'Stars', 'none', 'Choice', 'Price'},
    'Hotel-Recommend': {'Post', 'Addr', 'Internet', 'Price', 'Area', 'Name', 'Parking', 'Type', 'Stars', 'none',
                        'Choice', 'Phone'},
    'Hotel-Request': {'Internet', 'Area', 'Name', 'Parking', 'Type', 'Stars', 'Price'},
    'Hotel-Select': {'Addr', 'Internet', 'Price', 'Area', 'Name', 'Parking', 'Type', 'Stars', 'none', 'Choice',
                     'Phone'},
    ...
    'Train-Inform': {'Time', 'Leave', 'Day', 'Dest', 'Ref', 'Ticket', 'none', 'Choice', 'People', 'Id', 'Arrive',
                     'Depart'},
    'Train-NoOffer': {'Leave', 'Day', 'Dest', 'none', 'Choice', 'Id', 'Arrive', 'Depart'},
    'Train-OfferBook': {'Time', 'Leave', 'Day', 'Dest', 'Ref', 'Ticket', 'none', 'Choice', 'People', 'Id', 'Arrive',
                        'Depart'},
    'Train-OfferBooked': {'Time', 'Leave', 'Day', 'Dest', 'Ref', 'Ticket', 'none', 'Choice', 'People', 'Id', 'Arrive',
                          'Depart'},
