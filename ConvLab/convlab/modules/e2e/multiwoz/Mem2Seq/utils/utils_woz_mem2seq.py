...
class Dataset(data.Dataset):
    ...
    def __init__(self, src_seq, trg_seq, index_seq, gate_seq, src_word2id, trg_word2id, max_len, entity, conv_seq,
                 kb_arr):
    ...
    def __getitem__(self, index):
        ...
        return src_seq, trg_seq, index_s, gete_s, self.max_len, self.src_seqs[index], self.trg_seqs[index], self.entity[
            index], conv_seq, self.kb_arr[index]
...
def get_seq(pairs, lang, batch_size, type, max_len):
    ...
    dataset = Dataset(x_seq, y_seq, ptr_seq, gate_seq, lang.word2index, lang.word2index, max_len, entity, conv_seq,
                      kb_arr)
